...
parser.add_argument("--directory", type=str, default='data/pythia/JZ1', help="Path to the root file")
...
def main(args: argparse.Namespace) -> None:
    ...
    files = [os.path.join(args.directory, f'JZ{args.jz}', file, args.dataset_type) for file in os.listdir(
        os.path.join(args.directory, f'JZ{args.jz}')) if file.startswith('00')]
    ...
    dataset = JIDENNDataset.load(os.path.join(args.save_path, f'JZ{args.jz}', args.dataset_type))
