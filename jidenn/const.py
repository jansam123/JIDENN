...
METRIC_NAMING_SCHEMA = {
    ...
    'gluon_rejection_at_quark_80wp': r'$\varepsilon_g^{-1} @_{0.8} \varepsilon_q$',
    'gluon_rejection_at_quark_50wp': r'$\varepsilon_g^{-1} @_{0.5} \varepsilon_q$',
    'gluon_efficiency_at_quark_80wp': r'$\varepsilon_g @_{0.8} \varepsilon_q$',
    'gluon_efficiency_at_quark_50wp': r'$\varepsilon_q @_{0.5} \varepsilon_g$',
    'loss': 'Loss',
    'roc': 'ROC',
}
