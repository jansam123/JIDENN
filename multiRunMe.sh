...
#SBATCH --mem-per-cpu=12G                               # memory resource per cpu
...
ch-run -w -c /home/jankovys/JIDENN /home/jankovys/cuda -- python3 runMe.py data.subfolder_id=$SLURM_ARRAY_TASK_ID  hydra.run.dir="logs/multirun_fast/$SLURM_ARRAY_TASK_ID"  
