...
def main(args: argparse.Namespace):
    filenames = ['good_logs/comparison/depart/eval/results.csv', 'good_logs/comparison/part/eval/results.csv',
                 'good_logs/comparison/highway/eval/results.csv', 'good_logs/comparison/transformer/eval/results.csv', 'good_logs/comparison/bdt/eval/results.csv']
    model_names = ['depart', 'part', 'highway', 'transformer', 'bdt']
    save_dir = 'good_logs/comparison/plots/'
    take = 0
