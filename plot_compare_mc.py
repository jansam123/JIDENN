...
def main(args: argparse.Namespace):
    ...
    for model in args.model_names:
        ...
        for dir in args.load_dirs:
            ...
            df.to_csv(os.path.join(dir, 'models', f'{model}', 'binned_metrics.csv'), index=False)
...
if __name__ == "__main__":
    ...
    for wp_val in [0.5, 0.8]:
        ...
        load_dir = f'/home/jankovys/JIDENN/logs/pythia_Wflat_JZ7_cut/evaluation/{wp}wp'
        ...
        args.metric_n_counts = ['eff_num_events_g', 'eff_num_events_q', 'eff_num_events_g']
